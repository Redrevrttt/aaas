        ...
        if (args[0]) {
            ...
            if (comando) {
                let embed = new Discord.EmbedBuilder()
                    ...
                    .setFooter({ text: `Ultra`, iconURL: `https://cdn.discordapp.com/icons/1015723532933664789/7dd061501c08394df477661da8bf6896.png?size=1024` })
            ...
            .setColor(client.color)
            .setDescription(`Bot \`Ultra\``)
            .addFields([{name: `❓ **__Bot UltraCraftMC__**`, value: `\n*`}], )
            .addFields([{name: `📈 **__ESTADÍSTICAS__**`, value: `⚙ **${client.commands.size} Comandos**\n📁 en **${client.guilds.cache.size} Servidores**\n📶 **\`${client.ws.ping}ms\` Ping**\n👤  **[UltraCraftMC](https://discord.gg/59m7E7uk5u)**`}], )
            .addFields([{name: `✍ **__Bot__**`, value: `[\`Bot\`](https://cdn.discordapp.com/icons/1015723532933664789/7dd061501c08394df477661da8bf6896.png?size=1024)`}], )
            .setThumbnail(message.guild.iconURL({ dynamic: true }))
            .setFooter({ text: `Página 1 / ${categorias.length+1}\n`, iconURL: `https://cdn.discordapp.com/icons/1015723532933664789/7dd061501c08394df477661da8bf6896.png?size=1024` })
            ...
            collector.on("collect", async (interaccion) => {
                if (interaccion.isButton()) {
                    ...
                    for (const seleccionado of interaccion.values) {
                        ...
                        .setThumbnail(message.guild.iconURL({ dynamic: true }))
                        .setDescription(comandos_de_categoria.length >= 1 ? `>>> *${comandos_de_categoria.map(comando => `\`${comando.replace(/.js/, "")}\``).join(" - ")}*` : `>>> *Todavía no hay comandos en esta categoría...*`)
                        .setFooter({text: ` | 2022`, iconURL: `https://cdn.discordapp.com/icons/1015723532933664789/7dd061501c08394df477661da8bf6896.png?size=1024` })
